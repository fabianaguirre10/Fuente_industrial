var isIE8 = !1, isIE9 = !1, $windowWidth, $windowHeight, $pageArea, isMobile = !1;
!function (a, b) {
...
var Main = function () {
    var a = function () {
        ...
        $(".todo-actions").length && $(".todo-actions").click(function () {
            return $(this).find("i").hasClass("fa-square-o") || $(this).find("i").hasClass("icon-check-empty") ? ($(this).find("i").hasClass("fa") ? $(this).find("i").removeClass("fa-square-o").addClass("fa-check-square-o") : $(this).find("i").removeClass("icon-check-empty").addClass("fa fa-check-square-o"), $(this).parent().find("span").css({opacity: .25}), $(this).parent().find(".desc").css("text-decoration", "line-through")) : ($(this).find("i").removeClass("fa-check-square-o").addClass("fa-square-o"), $(this).parent().find("span").css({opacity: 1}), $(this).parent().find(".desc").css("text-decoration", "none")), !1
        })
    }, e = function () {
        $(".tooltips").length && $(".tooltips").tooltip()
    }, f = function () {
        $(".sb-toggle").on("click", function (a) {
            $("body").hasClass("rtl") ? $(this).hasClass("open") ? ($(this).not(".sidebar-toggler ").find(".fa-outdent").removeClass("fa-outdent").addClass("fa-indent"), $(".sb-toggle").removeClass("open"), $("#page-sidebar").css({left: -$("#page-sidebar").outerWidth()})) : ($(this).not(".sidebar-toggler ").find(".fa-indent").removeClass("fa-indent").addClass("fa-outdent"), $(".sb-toggle").addClass("open"), $("#page-sidebar").css({left: 0})) : $(this).hasClass("open") ? ($(this).not(".sidebar-toggler ").find(".fa-indent").removeClass("fa-indent").addClass("fa-outdent"), $(".sb-toggle").removeClass("open"), $("#page-sidebar").css({right: -$("#page-sidebar").outerWidth()})) : ($(this).not(".sidebar-toggler ").find(".fa-outdent").removeClass("fa-outdent").addClass("fa-indent"), $(".sb-toggle").addClass("open"), $("#page-sidebar").css({right: 0})), a.preventDefault()
        }), $("#page-sidebar .media a").on("click", function (a) {
            $(this).closest(".tab-pane").css({right: $("#page-sidebar").outerWidth()}), a.preventDefault()
        }), $("#page-sidebar .sidebar-back").on("click", function (a) {
            $(this).closest(".tab-pane").css({right: 0}), a.preventDefault()
        ...
        $(".accordion .accordion-toggle").on("click", function () {
            currentTab = $(this), $("html,body").animate({scrollTop: currentTab.offset().top - 100}, 1e3)
        })
    }, k = function () {
            $(".navigation-toggler").click(function () {
                if($("body").hasClass("navigation-small"))
                {
                    ...
                    $(".hover-color-menu").removeClass("hover-color");
                    $(".hover-color-menu").hover(function(){
                ...
                else
                {
                    ...
                    $(".hover-color-menu").addClass("hover-color");
                    $(".hover-color").hover(function(){
                        $(this).css("border-left", "red solid 2px");
                        $(this).css({
        ...
        $(".go-top").on("click", function (a) {
            $("html, body").animate({scrollTop: 0}, "slow"), a.preventDefault()
        })
    }, o = function () {
        ...
        ($('input[type="checkbox"]').length || $('input[type="radio"]').length) && ($('input[type="checkbox"].grey, input[type="radio"].grey').iCheck({
        ...
        var a = $(".sidebar-search input"), b = $(".sidebar-search button");
        $(".sidebar-search");
        a.attr("data-default", $(a).outerWidth()).focus(function () {
            ...
            "" == $(this).val() && ($(this).hasClass("open") ? $(this).animate({
                ...
                $(this).hide()
            }) : $(this).animate({width: $(this).attr("data-default")}, 200))
        }), b.on("click", function () {
            if ($(a).is(":hidden")) $(a).addClass("open").css({width: 0, opacity: 0}).show().animate({
                width: 200,
                opacity: 1
            }, 200).focus(); else if ($(a).hasClass("open") && "" == $(a).val()) $(a).removeClass("open").animate({
                width: 0,
                opacity: 0
            }, 200, function () {
                $(this).hide()
    ...
    var t = function () {
        ...
        $(".boxed-patterns a").on("click", function () {
            ...
            } else swal({title: "Style selector", text: "Select boxed layout!", type: "error"});
            return !1
        })
    }, v = function () {
